...
function theme.set_highlights(options)
	...
	hl(0, "@conditional.lua", { fg = palette.magenta, bg = "NONE", italic = options.italics })
	...
	hl(0, "@keyword.abort", { fg = palette.magenta, bg = "NONE", italic = options.italics })
	...
	hl(0, "@keyword.function.lua", { fg = palette.magenta, bg = "NONE", italic = options.italics })
	hl(0, "@keyword.function.return", { fg = palette.magenta, bg = "NONE", italic = options.italics })
	hl(0, "@keyword.function.vim", { fg = palette.magenta, bg = "NONE", italic = options.italics })
	hl(0, "@keyword.if.vim", { fg = palette.magenta, bg = "NONE", italic = options.italics })
	...
	hl(0, "@keyword.repeat.python", { link = "Statement" })
	hl(0, "@keyword.return", { link = "Statement" })
	hl(0, "@keyword.return.vim", { fg = palette.magenta, bg = "NONE", italic = options.italics })
	...
	hl(0, "@object.key", { fg = palette.magenta, bg = "NONE", italic = options.italics })
